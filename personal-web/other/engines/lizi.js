$(document).ready(function(){
    ...
    particlesJS('lizitexiao', {particles: {color: '#fff', shape: 'circle', opacity: 1, size: 1, size_random: true, nb: 80, line_linked: {enable_auto: true, distance: 180, color: '#fff', opacity: 1, width: 1, condensed_mode: {enable: false, rotateX: 900, rotateY: 900}}, anim: {enable: true, speed: 1}}, interactivity: {enable: true, mouse: {distance: 300}, detect_on: 'canvas', mode: 'grab', line_linked: {opacity: .4}, events: {onclick: {enable: true, mode: 'push', nb: 6}}}, retina_detect: true});
